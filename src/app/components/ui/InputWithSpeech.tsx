...
interface InputWithSpeechProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, 'onChange' | 'value'> {
  label?: string;
  required?: boolean;
  value: string;
      ...
      <div className="relative">
        ...
        {isSupported && (
          <button
            ...
            className={`absolute right-2 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full flex items-center justify-center transition-all cursor-pointer ${
              isListening 
