...
/**
 * Liste chronologique simple des progrès : les plus récents en premier,
 * chaque progrès s'enchaîne sur la timeline avec un numéro de victoire.
 */
export function ProgressTimeline({ progressList, onEdit, onShare, onPin }: Props) {
  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-col gap-6 md:gap-10 pt-4 md:pt-6 relative z-20">
